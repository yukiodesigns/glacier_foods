  ...
  return (
    <div>
      ...
      <div className="md:w-1/2 md:mr-8">
        <img src="https://www.liveeatlearn.com/wp-content/uploads/2023/05/How-to-Cut-Pineapple-01.jpg" alt="Product" className="max-w-full h-auto" />
      </div>
