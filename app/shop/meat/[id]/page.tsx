  ...
  return (
    <div>
      ...
      <div className="md:w-1/2 md:mr-8">
        <img src="https://th.bing.com/th/id/R.7f5d64c0c61a1444ca40e9dcdd624525?rik=7DUjT07tpAghBA&pid=ImgRaw&r=0" alt="Product" className="max-w-full h-auto" />
      </div>
